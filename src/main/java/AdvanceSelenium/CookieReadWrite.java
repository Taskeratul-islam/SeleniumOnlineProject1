...
public class CookieReadWrite {
	...
	public static void main(String[] args) {
		...
		File filecreate = new File("C:\\Users\\Start\\OneDrive\\Desktop\\Cookie\\cookie.text");
		...
		try {
			...
			{
				bufferwite.write(cookies.getName() + ";" + cookies.getValue() + ";" + cookies.getDomain() + ";"+ cookies.getPath() + ";" + cookies.getExpiry() + ";" + cookies.isSecure());
				bufferwite.newLine();
			}
		...
		try {
			...
			File fileread = new File("C:\\Users\\Start\\OneDrive\\Desktop\\Cookie\\cookie.text");
